...
__description__ = "Expand system variables Unix style (vendored into varstore)"
__version__ = "1.0.0"
__license__ = "MIT"
__all__ = [
    "BadSubstitution",
...
def _recover_null():
    """Read EXPANDVARS_RECOVER_NULL from the environment (live)."""
    return os.environ.get("EXPANDVARS_RECOVER_NULL", None)
...
def expand(vars_, nounset=False, environ=os.environ, var_symbol="$", **kwargs):
    ...
    Example usage: ::
        ...
        from varstore.expand import expand
...
def expandvars(vars_, nounset=False, **kwargs):
    ...
    Example usage: ::
        ...
        from varstore.expand import expandvars
