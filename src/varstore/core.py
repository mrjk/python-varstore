...
This module provides core functionality used throughout varstore:
...
class VarStoreError(Exception):
    """Base class for all VarStore exceptions.

    This class serves as the root of the VarStore exception hierarchy.
    """
